...
function Rates() {
  return (
    <div className=" flex flex-col gap-4 rounded-xl xl:w-2/3 xl:items-center xl:justify-center xl:py-10">
      ...
      <div className="flex flex-col justify-center items-center gap-3 py-3 rounded-xl bg-[#f7f2f8] xl:flex-row xl:gap-6 xl:w-2/3 xl:py-4 xl:translate-x-[10em]">
        <div className="flex flex-row gap-4">
          <img src={IconStar} alt="A star icon who's rating reviews" />
          <img src={IconStar} alt="A star icon who's rating reviews" />
          <img src={IconStar} alt="A star icon who's rating reviews" />
